            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <?php 
                    $query = "SELECT * FROM users u INNER JOIN permission p ON u.permission = p.id";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    <div class="insertUserForm">
                        ...
                        <form name="userForm">
                            <input type="text" id="full_name" class="form-control bg-light border-0 small" placeholder="Nome Completo">
                            <input type="text" id="login" class="form-control bg-light border-0 small" placeholder="Login">
                            <input type="password" id="password" value="@abeille199" readonly class="form-control bg-light border-0 small" placeholder="Senha">
                            <div class="showpass" id="showpass" style="background-color: #f09; width: 190px; height: 20px;">
                            <span style="color: black;">Mostrar senha</span>
                        </div>
                            ...
                            <input type="text" id="cpf" class="form-control bg-light border-0 small" placeholder="CPF">
                            <input type="text" id="phone" class="form-control bg-light border-0 small" placeholder="Telefone">
                            <input type="email" id="email" class="form-control bg-light border-0 small" placeholder="E-mail">
                            <input type="file" id="picture" accept=".jpg, .png">

                            <a href="#" id="insertUser" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
